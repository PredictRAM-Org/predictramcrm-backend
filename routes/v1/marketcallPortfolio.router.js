const { MarketCallController, MarketCallPortfolioController } = require("../../controllers");
...
router.post(
  "/",
  roleBasedAccess([ROLES.EMPLOYEE, ROLES.ANALYST, ROLES.CLIENT]),
  // validate(MarketCallValidate.createMarketCall),
  MarketCallPortfolioController.createMarketCallPortfolio
);
router.get(
  "/",

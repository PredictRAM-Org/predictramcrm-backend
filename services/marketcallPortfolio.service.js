...
const { MarketCall, MarketCallPortfolio } = require("../models");
const UserService = require("./user.service");
const { sendToEmailQueue } = require("../Queue/email.queue");

module.exports = class MarketCallPortfolioService {
  static async createMarketCallPortfolio(payload, options = {}) {
    try {
      const marketCall = await MarketCallPortfolio.create([{ ...payload }], {
        ...options,
      });
      return marketCall;
    } catch (err) {
